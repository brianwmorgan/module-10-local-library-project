/* Each book represents a physical book but also contains additional information. In particular:
  ...
  - The borrows array is a list of transactions that have occurred with this book. For example, the first book has been borrowed 25 times.
        - The id for each "borrow" record matches with an account ID.
        - For the first book, the account with an ID of "5f446f2e2cfa3e1d234679b9" has not yet returned the book, so returned is 'false'.
*/
